...
- **Known nit, not fixed:** `scripts/ingest_tcgcsv.py:216` still writes `-- Foil rows discarded at source` into every generated SQL header. That is false as of migration 011. One-line fix, left out of PR #166 to keep the diff to the stated scope.
