...
- **Section 6 gives the Drive root as `/Users/ashwinsathe/My Google Drive/Personal/Games/Riftbound/RiftAcademy/`.** This session reached the same content through the Drive-for-Desktop shortcut mount instead (`.../CloudStorage/GoogleDrive-.../.shortcut-targets-by-id/145sHHILhOGI5GjOa0agpqy5np96cXJJ9/RiftAcademy/`). Not verified whether the documented path is still a live alias. Worth one check before the next thread is told to use it.
